...
# sem barra no final
ENV WAHA_API_URL="https://waha.thsolucoes.site"
ENV WAHA_API_KEY="e3121c21-dfd5-42c3-bc74-5e71dad28c91"
ENV WAHA_INSTANCE="default"

# número do whatsapp do admin para receber notificações
ENV WHATSAPP_ADMIN_NUMBER="556392764312"
